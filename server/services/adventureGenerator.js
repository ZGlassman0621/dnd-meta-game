...
const ADVENTURE_MODEL = process.env.OLLAMA_MODEL || 'gpt-oss:20b';  // Fast model for adventure generation
const NARRATIVE_MODEL = process.env.OLLAMA_MODEL || 'gpt-oss:20b';  // Better model for narrative generation
