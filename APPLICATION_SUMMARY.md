...
- **Claude Opus generation**: Comprehensive campaign plans generated by Claude Claude Opus
- **Plan components**:
...
- **Two-stage AI pipeline**:
  - **Claude Opus** — Generates campaign plans (world building, NPCs, quest arcs, factions)
  - **Claude Sonnet** — Runs interactive gameplay sessions (narration, combat, dialogue)
...
**Claude Opus** builds the world (campaign plans, NPCs, factions, quest arcs) → **Claude Sonnet** runs gameplay (narration, combat, dialogue with enforced D&D 5e rules). Both models use alias IDs (no date suffix) so they auto-update to the latest version.
